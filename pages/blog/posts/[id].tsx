...
export default function Post(props: PostProps) {
	return <main className="max-w-3xl mx-auto">
		...
		<p className="text-xs opacity-60 sm:mb-12 mb-8">{new Date(props.postData.date).toUTCString().substring(0, 16)}</p>
		<div className="post-content" dangerouslySetInnerHTML={{__html: props.postData.contentHTML}} />
	</main>;
}
